...
namespace FallingSandEngine
{
	...
	void SceneHierarchyPanel::DrawEntityNode(Entity entity)
	{
		...
		// Waits until end to not break the rest of the code for this menu item
	...
	static void DrawVec3Control(const std::string& label, glm::vec3& values, float resetValue = 0.0f, float columWidth = 90.0f)
	{
		...
		ImGui::SameLine();
		ImGui::DragFloat("##X", &values.x, 0.05f);
		ImGui::PopItemWidth();
		ImGui::SameLine();
		...
		ImGui::SameLine();
		ImGui::DragFloat("##Y", &values.y, 0.05f);
		ImGui::PopItemWidth();
		ImGui::SameLine();
		...
		ImGui::SameLine();
		ImGui::DragFloat("##Z", &values.z, 0.05f);
		ImGui::PopItemWidth();
